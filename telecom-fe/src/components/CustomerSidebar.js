...
const customerMenuItems = [
  ...
  },
  {
    ...
    icon: <Loyalty style={{ fontSize: "24px" }} />,
  ...
  },
  {
    ...
    icon: <Receipt style={{ fontSize: "24px" }} />,
    path: "/customer/unresolved-tickets",
  },
  {
    title: "Highest Value Voucher",
    icon: <Redeem style={{ fontSize: "24px" }} />,
    path: "/customer/highest-voucher",
  },
  {
    title: "Remaining Payment",
    icon: <Payment style={{ fontSize: "24px" }} />,
  ...
  {
    title: "Top Payments",
    icon: <MoneyOffCsred style={{ fontSize: "24px" }} />,
    path: "/customer/top-payments",
  },
  {
    title: "All Shops",
    icon: <Store style={{ fontSize: "24px" }} />,
  ...
  },
  {
    ...
    icon: <Cached style={{ fontSize: "24px" }} />,
