...
const AccountHighestVoucherTable = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}/api/customer/highest-voucher-value`,
        {
          method: "POST",
          headers: {
...
export default AccountHighestVoucherTable;