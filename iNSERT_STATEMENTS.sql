...
VALUES 
(1000, 500, 5000, 'Basic Plan', 20, 'Basic plan with SMS, talk time, and data'),
(2000, 1000, 10000, 'Premium Plan', 40, 'Premium plan with more SMS, minutes, and data'),
(1500, 800, 8000, 'Standard Plan', 30, 'Standard plan with moderate SMS, talk time, and data');

-- Insert Subscriptions
INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES 
('01012345678', 1, '2020-01-01', 'active'),
('01023456789', 2, '2021-05-05', 'onhold'),
('01034567890', 3, '2019-09-09', 'active'),
('01045678901', 2, '2022-08-22', 'active');

-- Insert Plan Usage
INSERT INTO Plan_Usage (start_date, end_date, data_consumption, minutes_used, SMS_sent, mobileNo, planID)
VALUES 
('2020-01-01', '2020-01-31', 1000, 200, 300, '01012345678', 1),
('2021-05-05', '2021-05-20', 500, 100, 150, '01023456789', 2),
('2019-09-09', '2019-09-30', 1200, 300, 400, '01034567890', 3),
('2022-08-22', '2022-08-31', 800, 150, 250, '01045678901', 2);
...
VALUES 
(1, 2, 25.00, '2024-11-05'),
(3, 4, 10.00, '2024-11-04');
...
VALUES 
(1, '123 Main St', '9AM - 6PM'),
(2, '456 High St', '10AM - 8PM');
...
VALUES 
(50, '2024-12-31', 100, '01012345678', 1, '2024-11-05'),
(20, '2024-12-31', 50, '01023456789', 2, '2024-11-04');
